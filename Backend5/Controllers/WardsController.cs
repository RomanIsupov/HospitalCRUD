...
namespace Backend5.Controllers
{
    public class WardsController : Controller
    {
        ...
        public async Task<IActionResult> Create(Int32? hospitalId, WardCreateModel model)
        {
            ...
            if (this.context.Wards.Any(x => x.HospitalId == hospitalId && x.Name == model.Name))
            {
                this.ModelState.AddModelError("", 
                    "Ward with the same name in this Hospital already exists already exists.");
            }
